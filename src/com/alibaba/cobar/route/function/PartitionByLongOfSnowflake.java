 ...
 */
public final class PartitionByLongOfSnowflake extends PartitionFunction implements RuleAlgorithm {
    public PartitionByLongOfSnowflake(String functionName) {
        this(functionName, null);
    }

    public PartitionByLongOfSnowflake(String functionName, List<Expression> arguments) {
    ...
    public Integer[] calculate(Map<? extends Object, ? extends Object> parameters) {
        ...
        //按Snowflake生成的ID,取高41位时间戳作为路由基本值
        long k = (key.longValue() >> 23) % 1024;
        
        rst[0] = partitionIndex(k);
        return rst;
    }
    ...
    public RuleAlgorithm constructMe(Object... objects) {
        ...
        PartitionByLongOfSnowflake partitionFunc = new PartitionByLongOfSnowflake(functionName, args);
